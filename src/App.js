  ...
  return (
    <div className="card char-card">
      ...
      <h2 className="card-title">
        Who's Flying
        <br />
        <span className="grad">Today?</span>
      </h2>
  ...
  return (
    <div className="card home-card">
      ...
      <div
        ...
        style={{ '--char-color': player.character.color }}
      >
      ...
      <h1 className="home-title">
        Ready to
        <br />
        <span className="grad">Launch?</span>
      </h1>

      <p className="home-sub">
        {totalQuestions} questions · {player.category}
        <br />
...
function Quiz({ player, onFinish }) {
  ...
  const progress =
    ((current + 1) / categoryQuestions.length) * 100;
  ...
  return (
    <div className="card result-card">
      <div
        ...
        style={{
          '--char-color': player.character.color,
        }}
      >
        {player.character.emoji}
      </div>
      ...
      <h2 className="res-title">
        Mission {pct >= 50 ? 'Complete' : 'Failed'}
      </h2>
